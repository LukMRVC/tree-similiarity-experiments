...
python3 plot_experiments_n.py --service ted-exp --config configs_revision/dataset_size/dblp/candidates_dblp_t6.json --storeplot "./plots/dataset_size/dblp/candidates_dblp_t6.pdf"
...
python3 plot_experiments_n.py --service ted-exp --config configs_revision/dataset_size/dblp/times_dblp_t6.json --storeplot "./plots/dataset_size/dblp/times_dblp_t6.pdf"
