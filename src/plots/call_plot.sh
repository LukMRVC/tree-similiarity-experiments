...
python3 plot_experiments.py --config configs/upperbound/dblp_runtime_k.json --storeplot "./dblp_runtime_k.pdf"
...
python3 plot_experiments.py --config configs/upperbound/python_runtime_k.json --storeplot "./python_runtime_k.pdf"
...
python3 plot_experiments.py --config configs/upperbound/sentiment_runtime_k.json --storeplot "./sentiment_runtime_k.pdf"
...
python3 plot_experiments.py --config configs/upperbound/swissprot_runtime_k.json --storeplot "./swissprot_runtime_k.pdf"
